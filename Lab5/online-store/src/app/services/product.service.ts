...
export class ProductService {
  ...
  products: Product[] = [
    ...
    { id: 10, categoryId: 2, name: 'HP Spectre x360', price: 680000, rating: 4.6, likes: 0, description: 'Convertible laptop.', link: 'https://kaspi.kz/shop/p/hp-spectre-x360-14-eu0006ua-9r291ea-chernyi-116815340/', image: '/assets/images/Laptops/hp-spectre.webp', images: ['/assets/images/Laptops/hp-spectre.webp', '/assets/images/Laptops/hp-spectre.webp', '/assets/images/Laptops/hp-spectre.webp'] },
    ...
    // Category 4: Gaming
    { id: 16, categoryId: 4, name: 'PlayStation 5 Slim', price: 260000, rating: 5.0, likes: 0, description: 'Best console.', link: 'https://kaspi.kz/shop/p/sony-playstation-5-slim-115183307/', image: '/assets/images/gaming/ps5-slim.webp', images: ['/assets/images/gaming/ps5-slim.webp', '/assets/images/gaming/ps5-slim.webp', '/assets/images/gaming/ps5-slim.webp'] },
    { id: 17, categoryId: 4, name: 'Xbox Series X', price: 245000, rating: 4.9, likes: 0, description: 'Game Pass power.', link: 'https://kaspi.kz/shop/p/xbox-series-x-1tb-chernyi-100720456/', image: '/assets/images/gaming/xbox-x.webp', images: ['/assets/images/gaming/xbox-x.webp', '/assets/images/gaming/xbox-x.webp', '/assets/images/gaming/xbox-x.webp'] },
    { id: 18, categoryId: 4, name: 'Nintendo Switch OLED', price: 165000, rating: 4.8, likes: 0, description: 'Gaming on the go.', link: 'https://kaspi.kz/shop/p/nintendo-switch-oled-belyi-102717804/', image: '/assets/images/gaming/nintendo-oled.webp', images: ['/assets/images/gaming/nintendo-oled.webp', '/assets/images/gaming/nintendo-oled.webp', '/assets/images/gaming/nintendo-oled.webp'] },
    { id: 19, categoryId: 4, name: 'Steam Deck OLED', price: 320000, rating: 4.9, likes: 0, description: 'Portable PC.', link: 'https://kaspi.kz/shop/p/valve-steam-deck-oled-512-gb-114841951/', image: '/assets/images/gaming/steam-deck.webp', images: ['/assets/images/gaming/steam-deck.webp', '/assets/images/gaming/steam-deck.webp', '/assets/images/gaming/steam-deck.webp'] },
    { id: 20, categoryId: 4, name: 'LEGO Star Wars', price: 85000, rating: 5.0, likes: 0, description: 'Millennium Falcon.', link: 'https://kaspi.kz/shop/p/lego-star-wars-sokol-tysjacheletija-75257-100062602/', image: '/assets/images/gaming/lego-falcon.webp', images: ['/assets/images/gaming/lego-falcon.webp', '/assets/images/gaming/lego-falcon.webp', '/assets/images/gaming/lego-falcon.webp'] },
  ];
